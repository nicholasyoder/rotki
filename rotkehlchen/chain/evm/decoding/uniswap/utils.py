...
def decode_uniswap_like_position_create_or_exit(
        decoded_events: list['EvmEvent'],
        evm_inquirer: 'EvmNodeInquirer',
    ...
    """Decode Uniswap like position create/exit events."""
    ...
    for spend_returns, deposit_withdraws, subtype in (
        ...
        if len(spend_returns) == 0 or len(deposit_withdraws) == 0:
            continue
