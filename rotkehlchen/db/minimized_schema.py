...
# Created at 2026-02-05 18:40:18 UTC with rotki version 1.41.4.dev535+gb4bb97a455.d20260203 by nicholasyoder
MINIMIZED_USER_DB_SCHEMA = {
    ...
    "history_events": "identifierintegernotnullprimarykey,entry_typeintegernotnull,group_identifiertextnotnull,sequence_indexintegernotnull,timestampintegernotnull,locationchar(1)notnulldefault('a')referenceslocation(location),location_labeltext,assettextnotnull,amounttextnotnull,notestext,typetextnotnull,subtypetextnotnull,extra_datatext,ignoredintegernotnulldefault0,modified_identifierintegerdefaultnull,foreignkey(asset)referencesassets(identifier)onupdatecascade,foreignkey(modified_identifier)referenceshistory_events(identifier)ondeletecascade,unique(group_identifier,sequence_index,modified_identifier)",
    ...
    "history_event_links": "left_event_idintegernotnull,right_event_idintegernotnull,link_typeintegernotnull,primarykey(left_event_id,link_type),foreignkey(left_event_id)referenceshistory_events(identifier)ondeletecascade,foreignkey(right_event_id)referenceshistory_events(identifier)ondeletecascade",
...
MINIMIZED_USER_DB_INDEXES = {
    ...
    "idx_history_events_null_modified": "createuniqueindexifnotexistsidx_history_events_null_modifiedonhistory_events(group_identifier,sequence_index)wheremodified_identifierisnull",
...
MINIMIZED_USER_DB_VIEWS = {
    "history_events_active": "createviewifnotexistshistory_events_activeasselect*fromhistory_eventswheremodified_identifierisnull",
}
